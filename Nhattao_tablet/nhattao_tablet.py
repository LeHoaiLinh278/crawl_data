...
df_alllink_item.to_csv('nhattao_tablet_alllink.csv', index=False)

# %%
df_alllink_item = pd.read_csv('nhattao_tablet_alllink.csv')
print(df_alllink_item.info())
...
if os.path.isfile('nhattao_tablet_data.csv'):
    print('file save data:....')
    df_item = pd.read_csv('nhattao_tablet_data.csv')
else:
    df_item.to_csv('nhattao_tablet_data.csv', index=False)
